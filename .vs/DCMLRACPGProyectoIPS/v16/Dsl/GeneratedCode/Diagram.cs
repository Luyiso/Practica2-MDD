...
namespace UPM_IPS.DCMLRACPGProyectoIPS
{
	...
	[DslModeling::DomainObjectId("8f4c5349-5b0f-417f-b726-07628c29b15a")]
	public partial class DCMLRACPGProyectoIPSDiagram : DslDiagrams::Diagram
	{
		...
		{
			if(element is global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElement)
			{
				global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleShape newShape = new global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElementReferencesTargets)
			{
				global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleConnector newShape = new global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleConnector(this.Partition);
				return newShape;
			}
		...
		protected override void InitializeShapeFields(global::System.Collections.Generic.IList<DslDiagrams::ShapeField> shapeFields)
		{
			...
			global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleShape.DecoratorsInitialized += ExampleShapeDecoratorMap.OnDecoratorsInitialized;
		}
		...
		internal static partial class ExampleShapeDecoratorMap
		{
			...
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				...
				propertyInfo = new DslDiagrams::AssociatedPropertyInfo(global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElement.NameDomainPropertyId);
		...
		private global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleRelationshipConnectAction exampleRelationshipConnectAction;
		/// <summary>
		...
		public override void OnViewMouseEnter(DslDiagrams::DiagramPointEventArgs pointArgs)
		{
			...
			if(activeView != null)
			{
				...
				if (SelectedToolboxItemSupportsFilterString(activeView, global::UPM_IPS.DCMLRACPGProyectoIPS.DCMLRACPGProyectoIPSToolboxHelper.ExampleRelationshipFilterString))
				{
					if (this.exampleRelationshipConnectAction == null)
					{
						this.exampleRelationshipConnectAction = new global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleRelationshipConnectAction(this);
		...
		/// </summary>
		public static readonly new global::System.Guid DomainClassId = new global::System.Guid(0x8f4c5349, 0x5b0f, 0x417f, 0xb7, 0x26, 0x07, 0x62, 0x8c, 0x29, 0xb1, 0x5a);
		/// <summary>
		/// Constructor
		/// </summary>
...
namespace UPM_IPS.DCMLRACPGProyectoIPS
{
		...
		/// </summary>
		[DslModeling::RuleOn(typeof(global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElement), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddShapeParentExistRulePriority, InitiallyDisabled=true)]
		[DslModeling::RuleOn(typeof(global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElementReferencesTargets), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
		internal sealed partial class FixUpDiagram : FixUpDiagramBase
		{
			...
			public static global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleModel GetParentForExampleElement( global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElement root )
			{
				// Segments 0 and 1
				global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleModel result = root.ExampleModel;
