...
namespace UPM_IPS.DCMLRACPGProyectoIPS
{
	...
	/// </summary>
	internal partial class DCMLRACPGProyectoIPSCommandSet : DCMLRACPGProyectoIPSCommandSetBase
	{
		/// <summary>
		/// Constructs a new DCMLRACPGProyectoIPSCommandSet.
		/// </summary>
		public DCMLRACPGProyectoIPSCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DCMLRACPGProyectoIPSCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DCMLRACPGProyectoIPSCommandSetBase.
		/// </summary>
		protected DCMLRACPGProyectoIPSCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDCMLRACPGProyectoIPSExplorerCommand,
				typeof(DCMLRACPGProyectoIPSEditorFactory).GUID);
		...
		{
			DCMLRACPGProyectoIPSExplorerToolWindow explorer = this.DCMLRACPGProyectoIPSExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected DCMLRACPGProyectoIPSDocData CurrentDCMLRACPGProyectoIPSDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DCMLRACPGProyectoIPSDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DCMLRACPGProyectoIPSDocView CurrentDCMLRACPGProyectoIPSDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DCMLRACPGProyectoIPSDocView;
			}
		}
		...
		/// </summary>
		protected DCMLRACPGProyectoIPSExplorerToolWindow DCMLRACPGProyectoIPSExplorerToolWindow
		{
			get
			{
				DCMLRACPGProyectoIPSExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DCMLRACPGProyectoIPSExplorerToolWindow), true) as DCMLRACPGProyectoIPSExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DCMLRACPGProyectoIPSExplorerToolWindow explorerWindow = this.DCMLRACPGProyectoIPSExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class DCMLRACPGProyectoIPSClipboardCommandSet : DCMLRACPGProyectoIPSClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new DCMLRACPGProyectoIPSClipboardCommandSet.
		/// </summary>
		public DCMLRACPGProyectoIPSClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class DCMLRACPGProyectoIPSClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new DCMLRACPGProyectoIPSClipboardCommandSetBase.
		/// </summary>
		protected DCMLRACPGProyectoIPSClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
