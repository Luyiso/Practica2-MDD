...
namespace UPM_IPS.DCMLRACPGProyectoIPS
{
	...
	public static partial class ExampleElementReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElement)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElement)
				{
					if (candidateTarget is global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElement)
					{
						global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElement sourceExampleElement = (global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElement)candidateSource;
						global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElement targetExampleElement = (global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElement)candidateTarget;
						if(targetExampleElement == null || sourceExampleElement == null || global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElementReferencesTargets.GetLinks(sourceExampleElement, targetExampleElement).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElement)
				{
					if (target is global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElement)
					{
						global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElement sourceAccepted = (global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElement)source;
						global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElement targetAccepted = (global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElement)target;
						DslModeling::ElementLink result = new global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleElementReferencesTargets(sourceAccepted, targetAccepted);
