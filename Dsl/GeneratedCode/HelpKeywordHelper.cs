...
namespace UPM_IPS.DCMLRACPGProyectoIPS
{
	...
	/// </remarks>
	public partial class DCMLRACPGProyectoIPSHelpKeywordHelper : DCMLRACPGProyectoIPSHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DCMLRACPGProyectoIPSHelpKeywordHelper.
		/// </summary>
		protected DCMLRACPGProyectoIPSHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DCMLRACPGProyectoIPSHelpKeywordHelper.
		/// </summary>
		public static DCMLRACPGProyectoIPSHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DCMLRACPGProyectoIPSHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DCMLRACPGProyectoIPSHelpKeywordHelperBase.
		/// </summary>
		protected DCMLRACPGProyectoIPSHelpKeywordHelperBase()
			: base() { }
