			...
			while (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
			{
				...
				else
				{
					...
					if (newExampleElementReferencesTargets != null)
					{
						...
						{	// The relationship should be serialized in short-form.
							DCMLRACPGProyectoIPSSerializationBehaviorSerializationMessages.ExpectingShortFormRelationship(serializationContext, reader, typeof(ExampleElementReferencesTargets));
						}
	...
	public partial class ExampleElementReferencesTargetsSerializer : DslModeling::DomainRelationshipXmlSerializer
	{
		...
		public override void Read(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				...
				{
					DCMLRACPGProyectoIPSSerializationBehaviorSerializationMessages.DanglingRelationship(serializationContext, reader, "ExampleElementReferencesTargets");
				}
			}
		...
		public override global::System.Collections.ObjectModel.ReadOnlyCollection<DslModeling::DomainXmlSerializerDirectoryEntry> AllSerializers
		{
			get
			{
				if (DCMLRACPGProyectoIPSSerializationBehavior.serializerTypes == null)
				{
					...
					DCMLRACPGProyectoIPSSerializationBehavior.serializerTypes = new global::System.Collections.Generic.List<DslModeling::DomainXmlSerializerDirectoryEntry>(7 + customSerializerCount);
					...
					DCMLRACPGProyectoIPSSerializationBehavior.serializerTypes.Add(new DslModeling::DomainXmlSerializerDirectoryEntry(ExampleElement.DomainClassId, typeof(ExampleElementSerializer)));
					...
					DCMLRACPGProyectoIPSSerializationBehavior.serializerTypes.Add(new DslModeling::DomainXmlSerializerDirectoryEntry(ExampleElementReferencesTargets.DomainClassId, typeof(ExampleElementReferencesTargetsSerializer)));
...
namespace UPM_IPS.DCMLRACPGProyectoIPS
{
	...
	[DslModeling::DomainModelSerializer(typeof(global::UPM_IPS.DCMLRACPGProyectoIPS.DCMLRACPGProyectoIPSDomainModel), global::UPM_IPS.DCMLRACPGProyectoIPS.DCMLRACPGProyectoIPSSerializationBehavior.DomainModelXmlNamespace, "DCMLRACPG_ProyIPS")]
	...
	public abstract partial class DCMLRACPGProyectoIPSDomainModelSerializerBase : DslModeling::IDomainModelSerializer
	{
			...
			System.Text.Encoding encoding)
		{
			...
			global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleModel rootElement = modelRoot as global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleModel;
			if (rootElement == null)
			{
			...
			System.Text.Encoding encoding)
		{
			...
			global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleModel typedRoot = modelRoot as global::UPM_IPS.DCMLRACPGProyectoIPS.ExampleModel;
			if (typedRoot == null)
			{
				string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
					global::UPM_IPS.DCMLRACPGProyectoIPS.DCMLRACPGProyectoIPSDomainModel.SingletonResourceManager.GetString("InvalidSaveRootElementType"),
