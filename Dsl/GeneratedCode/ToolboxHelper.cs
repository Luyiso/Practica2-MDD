...
namespace UPM_IPS.DCMLRACPGProyectoIPS
{
	...
	public abstract class DCMLRACPGProyectoIPSToolboxHelperBase
	{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.DCMLRACPGProyectoIPS.DCMLRACPGProyectoIPSDomainModel.SingletonResourceManager.GetString("DCMLRACPGProyectoIPSToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
