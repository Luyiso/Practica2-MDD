...
namespace UPM_IPS.DCMLRACPGProyectoIPS
{
	...
	[VSShell::ProvideStaticToolboxGroup("@DCMLRACPGProyectoIPSToolboxTab;UPM_IPS.DCMLRACPGProyectoIPS.Dsl.dll", "UPM_IPS.DCMLRACPGProyectoIPS.DCMLRACPGProyectoIPSToolboxTab")]
	[VSShell::ProvideStaticToolboxItem("UPM_IPS.DCMLRACPGProyectoIPS.DCMLRACPGProyectoIPSToolboxTab",
					"@ExampleElementToolboxItem;UPM_IPS.DCMLRACPGProyectoIPS.Dsl.dll", 
					"UPM_IPS.DCMLRACPGProyectoIPS.ExampleElementToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"CreateExampleClassF1Keyword", 
					"@ExampleElementToolboxBitmap;UPM_IPS.DCMLRACPGProyectoIPS.Dsl.dll", 
					0xff00ff,
					Index = 0)]
	[VSShell::ProvideStaticToolboxItem("UPM_IPS.DCMLRACPGProyectoIPS.DCMLRACPGProyectoIPSToolboxTab",
					"@ExampleRelationshipToolboxItem;UPM_IPS.DCMLRACPGProyectoIPS.Dsl.dll", 
					"UPM_IPS.DCMLRACPGProyectoIPS.ExampleRelationshipToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"ConnectExampleRelationF1Keyword", 
					"@ExampleRelationshipToolboxBitmap;UPM_IPS.DCMLRACPGProyectoIPS.Dsl.dll", 
					0xff00ff,
					Index = 1)]
